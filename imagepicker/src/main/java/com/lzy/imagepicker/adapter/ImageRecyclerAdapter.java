...
public class ImageRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    private class ImageViewHolder extends ViewHolder {
        ...
        ImageViewHolder(View itemView) {
            super(itemView);
            rootView = itemView;
            videoInfo = itemView.findViewById(R.id.ll_video_info);
            videoTime = itemView.findViewById(R.id.tv_video_time);
        ...
        void bind(final int position) {
            ...
            boolean showVideo = !TextUtils.isEmpty(imageItem.thumb);
            ...
            imagePicker.getImageLoader().displayImage(mActivity, showVideo ? imageItem.thumb : imageItem.path, ivThumb, mImageSize, mImageSize); //显示图片
        }
